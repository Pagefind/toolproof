module.exports = {
  information_for_contributors: [
    "This file has been adapted from https://github.com/microsoft/vscode/blob/main/extensions/yaml/syntaxes/yaml.tmLanguage.json",
  ],
  name: "Toolproof YAML",
  scopeName: "source.toolproof-yaml",
  patterns: [], // Will be filled out by our gen script
  repository: {
    "block-collection": {
      patterns: [
        {
